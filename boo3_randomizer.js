(function(){
  ...
  function rare(name){var n=name.slice(name.lastIndexOf('_')+1,-4);return n==='10'||n==='17'||n==='18'}
  function build(){
    var i,j,g;
  ...
  function render(){
    var chosen=shuffle(cards).slice(0,5);
