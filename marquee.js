(function(){
  ...
  var iconBase='https://github.com/DoodleBun/booyahstuff/raw/main/';
  var style=document.createElement('style');
  style.textContent=
    '#booyah-artist-marquee{width:min(100%,1120px);margin:18px auto 0;overflow:hidden;border-radius:0;background:transparent;border:0;box-shadow:none;padding:10px 0;position:relative}'+
    ...
    '#booyah-artist-marquee:before{left:0;background:linear-gradient(90deg,rgba(255,255,255,.35),rgba(255,255,255,0))}'+
    '#booyah-artist-marquee:after{right:0;background:linear-gradient(270deg,rgba(255,255,255,.35),rgba(255,255,255,0))}'+
    '#booyah-artist-marquee .bam-track{display:flex;width:max-content;animation:booyahMarquee 34s linear infinite}'+
    '#booyah-artist-marquee .bam-item{flex:0 0 auto;display:flex;align-items:center;gap:12px;margin:0 10px;padding:8px 14px;border-radius:999px;background:transparent;border:0;box-shadow:none;backdrop-filter:none}'+
    ...
    '@media (max-width:640px){#booyah-artist-marquee{margin-top:12px;padding:8px 0}#booyah-artist-marquee:before,#booyah-artist-marquee:after{width:24px}#booyah-artist-marquee .bam-item{gap:9px;margin:0 8px;padding:6px 10px}#booyah-artist-marquee .bam-icon{width:34px;height:34px}#booyah-artist-marquee .bam-name{font-size:.88rem}}';
