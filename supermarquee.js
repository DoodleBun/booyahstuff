// supermarquee.js - Fresh Artist Marquee for Booyah TCG
// Icons left | Name right • No pause on hover • Full bleed

document.addEventListener('DOMContentLoaded', () => {
  const container = document.getElementById('supermarquee');
  if (!container) {
    console.error("supermarquee: Add <div id='supermarquee'></div> where you want the marquee!");
    return;
  }
  ...
  const artists = [
    ...
    // Add new artists here ↑ (just copy the line and change name + img)
  ];
